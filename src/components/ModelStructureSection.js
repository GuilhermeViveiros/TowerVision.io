            ...
            <div className="stages-container">
              ...
              <div className="stage-item">
                ...
                <div className="stage-content">
                  ...
                  <p className="stage-description">
                    We unfreeze the full model and train it on the complete VisionBlocks dataset, excluding video-text data. This phase uses <strong>high-dynamic resolution</strong>, breaking high-resolution images into a grid of smaller tiles encoded independently (with a global thumbnail tile). We use a maximum of six tiles for optimal trade-off between context length, efficiency, and performance (see <a href="#ablation" className="ablation-link">Ablation Studies</a>). This produces the core <strong>TowerVision</strong> model.
                  </p>
                </div>
              </div>
              ...
              <div className="stage-item">
                ...
                <div className="stage-content">
                  ...
                  <p className="stage-description">
                    The video portion of VisionBlocks is used to finetune TowerVision on 32-frame video inputs at the encoder's fixed resolution of 384×384. Unlike the previous stage, we omit tiling for efficiency. This phase produces the <strong>TowerVideo</strong> model, extending capabilities to video understanding tasks.
                  </p>
                </div>
              </div>
            </div>
